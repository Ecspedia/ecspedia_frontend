      ...
      <div className="relative">
        <div className="mb-3">
          <div className="flex items-baseline mt-2 lg:mt-0 gap-1 lg:gap-3 flex-col lg:flex-row">
            ...
            <p className="text-base font-normal text-primary">Discover our most loved hotels</p>
          </div>
        </div>
        ...
        <ScrollableList
          ...
          initialBatchSize={6}
          renderItem={(item, index) => <HotelCard key={item.id} priority={index === 0 || index === 1} hotel={item} variant="vertical-card" className="max-w-sm min-h-100" />}
        />
      </div>
    </section>
  );
