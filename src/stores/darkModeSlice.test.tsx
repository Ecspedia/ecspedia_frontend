...
describe('Dark Mode Toggle component test', () => {
  ...
  it('should render the moon icon when dark mode is enabled', () => {
    // Set dark mode in store directly (component no longer initializes from localStorage)
    store.dispatch(setDarkMode(true));
  ...
  describe('Integration Test', () => {
    it('should toggle to dark mode when the toggle button is clicked', () => {
      ...
      expect((store.getState() as RootState).darkMode.isDarkMode).toBe(true);
      // Check document class was updated (simulated by provider, but we can test the state)
    });
    
    it('should toggle to light mode when the toggle button is clicked', () => {
